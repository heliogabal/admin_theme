...
function admin_theme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $old_css_path = $admin_theme_path . '/css/custom.css';
  ...
  $form['admin_theme_custom'] = array(
    '#type' => 'fieldset',
    '#title' => t('Adminimal Customization'),
    '#weight' => -10,
  );

  $form['admin_theme_custom']['display_icons_config'] = array(
    '#type' => 'checkbox',
    '#title' => t('Display icons in Configuration page'),
    '#default_value' => theme_get_setting('display_icons_config'),
  );

  $form['admin_theme_custom']['use_custom_media_queries'] = array(
    '#type' => 'checkbox',
  ...
  $form['admin_theme_custom']['media_queries'] = array(
    '#type' => 'fieldset',
  ...
  $form['admin_theme_custom']['media_queries']['media_query_mobile'] = array(
    '#type' => 'textfield',
  ...
  $form['admin_theme_custom']['media_queries']['media_query_tablet'] = array(
    '#type' => 'textfield',
  ...
  $form['admin_theme_custom']['custom_css'] = array(
    '#type' => 'checkbox',
  ...
  $form['admin_theme_custom']['admin_theme_custom_check'] = array(
    '#type' => 'fieldset',
  ...
  if (file_exists($custom_css_path)) {
    $form['admin_theme_custom']['admin_theme_custom_check']['custom_css_description'] = array(
    ...
    $form['admin_theme_custom']['admin_theme_custom_check']['custom_css_not_found'] = array(
